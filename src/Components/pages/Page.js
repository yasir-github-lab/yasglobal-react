...
function Page() {
  ...
  useEffect(() => {
    fetch(`https://dev.yasglobal.com/wp-json/wp/v2/pages?slug=${slug}&_embed&custom-meta`)
      ...
      console.log(`https://dev.yasglobal.com/wp-json/wp/v2/pages?slug=${slug}&_embed&custom-meta`);
  }, [slug]);
